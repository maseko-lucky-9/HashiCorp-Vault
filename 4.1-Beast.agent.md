...
This section maps abstract references in the architecture spec to concrete file paths:

| Spec Reference                              | Concrete Path                                |
| ------------------------------------------- | -------------------------------------------- |
| "directives/" (line 17)                     | `directives/`                                |
| "execution/" (line 32)                      | `execution/`                                 |
| "directives/scrape_website.md" (line 27)    | `directives/scrape_website.md`               |
| "execution/scrape_single_site.py" (line 28) | `execution/scrape_single_site.py`            |
| ".env" (line 33)                            | `.env` / `.env.example`                      |
| "memory.instruction.md" (line 173)          | `.github/instructions/memory.instruction.md` |
